...
import {View,FlatList,Text,Button,TouchableOpacity,Image} from 'react-native';
    ...
    return (
        <View style={styles.contentServicosProximos}>
          ...
          <View style={styles.containerFlatListProximo}>
            <FlatList style={styles.padraoFLatList}
              ItemSeparatorComponent={() => (
                <View style={styles.separatorDown} />)} ListEmptyComponent={() => (
                  ...
                  renderItem={({item, index}) => (
                    <TouchableOpacity style={styles.touchableServicoBig}  onPress={() => { // this.props.navigation.navigate('Agenda');
                    }}>
